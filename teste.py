...
def Main():
    ...
    bg_photo = tk.PhotoImage(file = "trabalho.png")
    ...
    # Título centralizado
    titulo_label = tk.Label(root, text="Bem-vindo ao Touch", background="white" , font=("Helvetica", 20))
    ...
    button_mostrar = tk.Button(root, text="Informações", bg="pink" , command=mostrar_dados)
    button_mostrar.place(relx=0.5, rely=0.8, anchor="center")

    button_quit = tk.Button(root, text="Sair", command=root.destroy)
